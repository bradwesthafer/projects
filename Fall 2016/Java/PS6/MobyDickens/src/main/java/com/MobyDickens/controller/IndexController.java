...
public class IndexController {
    ...
    public String addBook(@RequestParam(value="bookTitle") String bookTitle,  @RequestParam(value="bookPrice") String bookPrice, @RequestParam(value="bookAuthor") String bookAuthor, @RequestParam(value="bookISBN") String bookISBN, @RequestParam(value="bookGenre") String bookGenre) {

        Book book = new Book(/*bookService.getNextID(),*/ bookTitle, Long.valueOf(bookISBN), bookAuthor, /*LocalDateTime.now()*/new Date(System.currentTimeMillis()), bookGenre, Double.valueOf(bookPrice));
    ...
    public String editBook(@PathVariable Integer bookID, @RequestParam(value="bookTitle") String bookTitle,  @RequestParam(value="bookPrice") String bookPrice, @RequestParam(value="bookAuthor") String bookAuthor, @RequestParam(value="bookISBN") String bookISBN, @RequestParam(value="bookGenre") String bookGenre) {

        Book book = new Book(bookTitle, Long.valueOf(bookISBN), bookAuthor, bookService.findByID(bookID).getDatePublished(), bookGenre, Double.valueOf(bookPrice));
